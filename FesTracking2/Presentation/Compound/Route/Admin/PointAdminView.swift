...
struct PointAdminView: View {
    @Bindable var store: StoreOf<PointAdminFeature>
...
#Preview{
    PointAdminView(store: Store(initialState: PointAdminFeature.State(item: Point.sample), reducer: { PointAdminFeature() }))
}
