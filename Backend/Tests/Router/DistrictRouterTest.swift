...
struct DistrictRouterTest {
    ...
    let tool = DistrictTool(districtId: "d-id", districtName: "d-name", festivalId: "f-id", festivalName: "f-name", milestones: [], base: Coordinate(latitude: 0.0, longitude: 0.0), spans: [])
