...
final class DistrictControllerMock: DistrictControllerProtocol, @unchecked Sendable {
    ...
    func updateDistrict(_ request: Backend.Request, next: @Sendable (Backend.Application.Request) async throws -> Backend.Application.Response) async throws -> Backend.Response {
